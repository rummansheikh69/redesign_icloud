...
const HELP_URL = "https://support.apple.com/guide/icloud/welcome/icloud";
...
function Navbar() {
  ...
  return (
    <div
      className="fixed top-0 w-full flex items-center h-[43px] backdrop-blur-[10px] z-50"
      style={{
        background: "var(--navbar-bg)",
      }}
    >
      <div className="w-full pl-[14px] pr-[12px] flex items-center justify-between">
        <div>
          <svg
            width="82"
            height="31"
            xmlns="http://www.w3.org/2000/svg"
            className="apple-icloud-logo"
            aria-hidden="true"
          >
            <g fillRule="nonzero" className="icloud-logo-mark">
              <path
        ...
        <div className="relative" ref={wrapRef}>
          <button
            ...
            className={`flex items-center justify-center w-[28px] h-[28px] rounded-[8px] transition ${
              menuOpen ? "bg-black/10" : "hover:bg-black/5"
            }`}
          >
            <svg
              className="ellipsis icloud-ellipsis"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 64 64"
              height="18"
              width="18"
          ...
          <AnimatePresence>
            {menuOpen && (
              <motion.a
                ...
                className="absolute right-0 top-[calc(100%+10px)] z-[60] inline-flex items-center gap-[7px] whitespace-nowrap rounded-full bg-white px-[12px] py-[8px] text-[13px] font-medium text-[#0066cc] shadow-[0_8px_28px_rgba(0,0,0,0.12),0_2px_6px_rgba(0,0,0,0.06)] border border-black/[0.04] hover:bg-[#f5f5f7]"
                onClick={() => setMenuOpen(false)}
              >
                <IoHelpCircleOutline className="w-[16px] h-[16px] shrink-0" />
                <span>iCloud-Benutzerhandbuch</span>
                <GoArrowUpRight className="w-[14px] h-[14px] shrink-0 opacity-80" />
              </motion.a>
            )}
          </AnimatePresence>
        </div>
